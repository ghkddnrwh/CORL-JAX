...
class TrainConfig:
    ...
    actor_update_method: str = "td3_weighted_bc"  # one of: td3_bc, weighted_bc, td3_weighted_bc, iql_awbc
    actor_lr: float = 3e-4
...
class SACDAFJAX:
    ...
    def fit_actor(
        ...
        q_params = self.state.q_target_params if self.actor_update_method in IQL_ACTOR_METHODS else self.state.q_params
