...
class TrainConfig:
    ...
    # Actor update during main training
    # td3_bc: TD3+BC-style actor objective using Q(s, pi(s)) plus plain BC.
    # weighted_bc: advantage-weighted behavior cloning from dataset actions.
    # td3_weighted_bc: TD3+BC Q-improvement term plus advantage-weighted BC.
...
class SACDAFJAX:
    ...
    def _build_train_step(self):
        ...
        def train_step(state: SACDAFState, actor_state: ActorState, batch: TensorBatch):
            ...
            # Actor update is part of the same train step. It uses the freshly
            # updated Q/V parameters from this iteration instead of running a
            # separate post-hoc policy training phase.
            def actor_loss_fn(actor_params):
                ...
                # delayed advantage Q_d(s,a)-V_d(s) used by the value update.
            ...
            (actor_loss, (actor_q, actor_lmbda, actor_bc_loss, actor_weighted_bc_loss, policy_weight_mean, policy_weight_max)), actor_grads = jax.value_and_grad(actor_loss_fn, has_aux=True)(actor_state.params)
