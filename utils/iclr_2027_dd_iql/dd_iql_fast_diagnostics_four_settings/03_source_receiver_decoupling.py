...
def main():
    ...
    write_latex_rows(
        out_dir / "latex_source_receiver_loo_table_rows.txt",
        "DD-IQL source vs receiver LOO coupling -- four settings per environment",
        decoupling_columns,
        decoupling_all,
        common_comments,
    )
    ...
    write_latex_rows(
        out_dir / "latex_source_receiver_loo_primary_rows.txt",
        "DD-IQL source vs receiver LOO coupling -- four settings per environment (legacy filename)",
        decoupling_columns,
        decoupling_all,
        common_comments,
    )
    ...
    write_latex_rows(
        out_dir / "latex_filter_signal_table_rows.txt",
        "DD-IQL filtering-signal preservation -- four settings per environment",
        signal_columns,
        signal_all,
        common_comments,
    )
    ...
    write_latex_rows(
        out_dir / "latex_filter_signal_primary_rows.txt",
        "DD-IQL filtering-signal preservation -- four settings per environment (legacy filename)",
        signal_columns,
        signal_all,
        common_comments,
    )
