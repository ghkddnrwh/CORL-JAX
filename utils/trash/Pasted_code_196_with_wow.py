...
# def format_setting_label(setting: ArgSetting, lr: Any, bc_coef: Any, wow: Any) -> str:
#     setting_part = ", ".join(
...
#     wow_text = format_path_value(wow)
#     if setting_part:
#         return f"{setting_part}, lr={lr_text}, bc={bc_text}, wow={wow_text}"
#     return f"lr={lr_text}, bc={bc_text}, wow={wow_text}"
...
#       actor_refit/weighted_bc/{lr}/{bc_coef}/{wow}/fit_eval_logs.npz
#     """
...
#     actor_fit_method: str = "weighted_bc",
# ) -> str:
#     label = format_setting_label(setting, lr, bc_coef, wow)
#     row = f"{label} & "
...
#     parser.add_argument("--algo_name", type=str, default="SA-CDAF-JAX")
#     parser.add_argument("--root_path", type=str, default="logs/tuning/cdaf_jax_coverage_margin/init_max/increased_discount/")
#     parser.add_argument("--actor_fit_method", type=str, default="td3_weighted_bc")
#     parser.add_argument("--metric_name", type=str, default="best_d4rl_normalized_score_mean")
#     parser.add_argument("--seeds", type=int, nargs="+", default=[0])
#     parser.add_argument("--wow", type=float, nargs="+", default=[2.0])
